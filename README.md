...
scans (18 and 10 in [PR #27](https://github.com/use-assay/Assay/pull/27), not yet
merged), and the round trip — scan, attest, `get_safety` — is reproducible end to
...
- **Coverage is 7 attested assets on `main`** (10 in PR #27). Everything else on the network returns `None`.
